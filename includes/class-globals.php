...
if ( class_exists( 'CustomStockMessagesForWoocommerce\Globals' ) ) {
	return;
}
...
class Globals {
	...
	public static function get_default_options_array() {
		...
		$default_options = apply_filters( 'custom_stock_messages_for_woocommerce_admin_settings_default', $default_options );
	...
	public static function get_meta_prefix() {
		return apply_filters( 'custom_stock_messages_for_woocommerce_global_meta_prefix', static::$prefix );
	}
