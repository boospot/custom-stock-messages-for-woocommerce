...
class Init {
	...
	public function __construct() {
		...
		if ( defined( 'CSMFW_VERSION' ) ) {
			$this->version = CSMFW_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		if ( defined( 'CSMFW_NAME' ) ) {
			$this->plugin_name = CSMFW_NAME;
		} else {
			$this->plugin_name = 'custom-stock-messages-for-woocommerce';
		}
